...
public class WeatherRDDLoaderFromTextFile {
    ...
    public JavaRDD<WeatherMeasurementPojo> loadWeatherMeasurementPojoRDD(String filePath, IMeasurementValidator validator) {
        ...
        JavaRDD<WeatherMeasurementPojo> result = nonHeaderCSV.flatMap(
                new WeatherMeasurementParserFlatMap(csvHeader).setCitiesMap(cities).setValidator(validator)
        );
